...
public class TemplatedSecretsGeneratorRequestTest {
  @Test public void deserializesCorrectly() throws Exception {
    TemplatedSecretsGeneratorRequest templatedSecretsGeneratorRequest =
    ...
    assertThat(fromJson(jsonFixture("fixtures/templatedSecretsGeneratorRequest.json"),
        TemplatedSecretsGeneratorRequest.class))
        .isEqualTo(templatedSecretsGeneratorRequest);
  }
}
