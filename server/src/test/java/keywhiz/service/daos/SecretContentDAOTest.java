...
public class SecretContentDAOTest {
  ...
  @Test public void createSecretContent() {
    ...
    secretContentDAO.createSecretContent(secretContent1.secretSeriesId(), "encrypted", "creator",
        metadata, 0);
    secretContentDAO.createSecretContent(secretContent1.secretSeriesId(), "encrypted2", "creator",
        metadata, 0);
    secretContentDAO.createSecretContent(secretContent1.secretSeriesId(), "encrypted3", "creator",
        metadata, 0);
  ...
  @Test public void getSecretContentsBySecretId() {
    long id1 = secretContentDAO.createSecretContent(secretContent1.secretSeriesId(), "encrypted", "creator",
        metadata, 0);
    long id2 = secretContentDAO.createSecretContent(secretContent1.secretSeriesId(), "encrypted2", "creator",
        metadata, 0);
    long id3 = secretContentDAO.createSecretContent(secretContent1.secretSeriesId(), "encrypted3", "creator",
        metadata, 0);
